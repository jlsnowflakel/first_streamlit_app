...
streamlit.text('🐔 Hcard-Boiled free-Range Egg')
...
try:
   ...
   If not fruit_choice:  
        streamlit.error("Please select a fruit a fruit to get information.")
    else:
        fruityvice_response = requests.get("https://fruityvice.com/api/fruit/" + fruit_choice)
        fruityvie_normalized = pandas.json_normalize(fruityvice_response.json())
        streamlit.dataframe(fruityvie_normalized)
...
fruit_second_choice = streamlit.text_input('What fruit would you like to add?', 'jackfruit')
